...
func New(configOptions *ConfigOptions) *cobra.Command {
	...
	flags.StringVarP(&configOptions.ConfigFile, "config", "", configOptions.ConfigFile, "Config file path (default "+filepath.Join("$HOME", configDir, configName+".yaml")+" if exists)")
